<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Administrar distribuidores</li>
  ...
  <section class="content">
    ...
    <div class="box">
      ...
      <div class="box-header with-border">
        ...
        <button class="btn btn-primary btnAgregar btnCrearUsuario" data-toggle="modal" data-target="#modalDist">
        ...
        <table class="table table-bordered table-striped dt-responsive tablas" width="100%">
          ...
          <thead>
            ...
            <tr>
              ...
              include "includes/columns_mayoristas_dists.html"; ?>
          ...
          <tbody>
            ...
            foreach ($dists as $key => $value) {
              ...
              echo '
                    <td>
                      ...
                      <div class="btn-group">
                        ...
                        <button class="btn btn-warning btnEditarUsuario" data-toggle="modal" data-target="#modalDist" tabla="dists" idUsuario="' . $value["ID"] . '"><i class="fa fa-pencil"></i></button>

                        <button class="btn btn-danger btnEliminarUsuario" idUsuario="' . $value["ID"] . '" " fotoUsuario="' . $value["foto"] . '" tabla="dists"><i class="fa fa-times"></i></button>
              ...
              echo '<td>' . $value["total_pedidos"] . '</td>
...
<div id="modalDist" class="modal fade" role="dialog">
    ...
    <div class="modal-content">
      ...
      <form role="form" enctype="multipart/form-data" method="post">
        ...
        <div class="modal-header" style="background:#3c8dbc; color:white">
          ...
          <h4 class="modal-title">Formulario Distribuidor</h4>
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <select class="form-control input-lg" name="Agente" id="AgenteSelect" required>
...
<!--
Distribuidores directos para el fabricante
-->