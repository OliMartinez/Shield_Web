        ...
        <section class="content">
            ...
            <div class="box">
                ...
                <div class="box-header with-border">
                    ...
                    <button class="btn btn-primary btnAgregar btnCrearZona" data-toggle="modal" data-target="#modalZona">
                ...
                <div class="box-body">
                    ...
                    <table class="table table-bordered table-striped dt-responsive tablas" width="100%">
                        ...
                        <tbody>
                            ...
                            <td>
                                <div class="btn-group">
                                    <button class="btn btn-warning btnEditarZona" data-toggle="modal" data-target="#modalZona" tabla="zonas" idZona="' . $value["ID"] . '"><i class="fa fa-pencil"></i></button>                   
                                    <button class="btn btn-danger btnEliminarZona" idZona="' . $value["ID"] . ' tabla="zonas"><i class="fa fa-times"></i></button>                      
                                </div>                  
                            </td>
                            <td>';
                                    echo '
