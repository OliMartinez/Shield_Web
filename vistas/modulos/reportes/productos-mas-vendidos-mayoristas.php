...
<div class="box box-default">
  ...
  <div class="box-header with-border">
    ...
    <h3 class="box-title">
      <?php if ($_SESSION["tipo"] == 'Administrador') {
        echo 'Productos más vendidos de Mayoristas a Distribuidores';
      }
       else if ($_SESSION["tipo"] == 'Mayorista') {
        echo 'Producuctos más vendidos a Distribuidores';
      } ?>
    </h3>
      ...
      <div class="col-md-5">
        ...
        <ul class="chart-legend clearfix">
          ...
          for ($i = 0; $i < $lim; $i++) {
            ...
            echo ' <li><i class="fa fa-circle-o text-' . $colores[$i] . '"></i> ' . $productosmayoristas[$i]["nombre"] . '</li>';
          }
  ...
  <div class="box-footer no-padding">
    ...
    <ul class="nav nav-pills nav-stacked">
      ...
      <?php
      $lim = 0;
      if (count($productosmayoristas) > 5) {
        $lim = 5;
      } else {
        $lim = count($productosmayoristas);
      }
...
<script>
  ...
  var PieData2 = [
    ...
    for ($i = 0; $i < $lim; $i++) {
      ...
      color    : '" . $colores[$i] . "',
      highlight: '" . $colores[$i] . "',
      label    : 'unidades de " . $productosmayoristas[$i]["nombre"] . "'
    },";
    }
